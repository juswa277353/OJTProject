...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    for first name, last name, profile picture, role, phone number, and birthday.
    """
    ROLE_CHOICES = (
        ('admin', 'Admin'),
        ('client', 'Client'),
    ...
    role = models.CharField(max_length=10, choices=ROLE_CHOICES, default='guest') # Changed default to 'guest'
    phone_number = models.CharField(max_length=20, blank=True, null=True) # New field
    birthday = models.DateField(blank=True, null=True) # New field
